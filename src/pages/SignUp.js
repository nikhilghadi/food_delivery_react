...
export default function SignUp() {
  ...
  const handleSubmit= async(e)=>{ 
    ...
    if (json.success){
      ...
      alert(json.errors.map((a)=> a.msg).join(', '))
    }
  }
  ...
  return (
    <div>
      <section className="bg-white-50 dark:bg-white mt-16">
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#" onSubmit={handleSubmit} onChange={handleChange}>
                  <div>
                      ...
                      <input value={credentials.name} type="text" name="name" id="name" className="bg-gray-50 border border-white-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-blue-200 dark:border-white-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-green-500" placeholder="Enter Name" required=""/>
                  </div>
                  <div>
                  ...
                  <div>
                      ...
                      <input value={credentials.confirm_password} type="confirm-password" name="confirm-password" id="confirm-password" placeholder="••••••••" className="bg-gray-50 border border-white-300 text-black-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-blue-200 dark:border-white-600 dark:placeholder-white-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" required=""/>
                  </div>
                  <div>
                      <label htmlFor="location" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Location</label>
                      <input value={credentials.location} type="text" name="location" id="location" className="bg-gray-50 border border-white-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-blue-200 dark:border-white-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-green-500" placeholder="Enter Location" required=""/>
                  </div>
                  ...
                  <button type="submit" className="w-full text-white bg-red-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create an account</button>
